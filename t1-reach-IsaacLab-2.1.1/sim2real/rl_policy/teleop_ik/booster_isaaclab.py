...
class BoosterTeleop(DecLocomotionPolicy):
    ...
    def rl_inference(self, robot_state_data):
        ...
        obs_buffer_dict["dof_vel_scaled"] = obs_buffer_dict["dof_vel"] * 0.05
        obs_buffer_dict["base_angvel_scaled"] = obs_buffer_dict["base_ang_vel"] * 0.2
        ...
        obs_list = [
            "projected_gravity", "base_angvel_scaled",
            "command_lin_vel", "command_ang_vel",
            "cos_phase", "sin_phase",
            "dof_pos", "dof_vel_scaled",
            "last_policy_action"
        ]
