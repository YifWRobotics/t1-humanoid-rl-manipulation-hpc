...
@configclass
class RslRlLipPpoAlgorithmCfg:
    """Configuration for the PPO algorithm."""

    class_name: str = "LipPPO"
    """The algorithm class name. Default is PPO."""
    ...
    lipschitz_penalty_coeff: float = 0.1
    """The coefficient for the Lipschitz penalty regularization. Default is 0.0 (disabled)."""
...
class RslRlOnPolicyRunnerCfg:
    ...
    algorithm: RslRlPpoAlgorithmCfg | RslRlDistillationAlgorithmCfg | RslRlLipPpoAlgorithmCfg = MISSING
