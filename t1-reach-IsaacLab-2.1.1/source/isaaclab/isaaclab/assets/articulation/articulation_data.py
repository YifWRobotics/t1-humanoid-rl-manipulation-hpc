...
class ArticulationData:
    ...
    This quantity is configured through the :attr:`isaaclab.assets.ArticulationCfg.init_state` parameter.
    """
    default_upper_joint_pos: torch.Tensor = None
    ...
    diff_error_torque: torch.Tensor = None
    """Joint torques computed from joints of left and right legs. Shape is (num_instances, num_joints).
    """
    ##
    # Joint properties.
    ##
